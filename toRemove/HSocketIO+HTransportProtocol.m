...
#import "HSocketIO+HTransportProtocol.h"
#import "HReconnect.h"
#import "HSocketIO+HReconnectDelegate.h"
#import "HErrors.h"
#import "HMessage.h"
...
@implementation HSocketIO (HTransportProtocol)
...
- (id)initWithOptions:(HOptions *)theOptions delegate:(id<HTransportDelegate>)aDelegate {
    ...
    if (self) {
        ...
        self.reconnectPlugin = [[HReconnect alloc] initWithDelegate:self];
    }
