...
+ (id)optionsWithDict:(NSDictionary *)dict {
    return [[HOptions alloc] initWithDict:dict];
}
...
+ (id)optionsWithPlist:(NSString *)path {
    return [[HOptions alloc] initWithPlist:path];
}
...
-(id)initWithDict:(NSDictionary *)dict {
    ...
    if (self) {
        ...
        _domain = @"";
        route = @"";
        _gateway = [HGatewayOptions optionsWithDict:[dict objectForKey:@"gateway"]];
